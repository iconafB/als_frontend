...
const DedupedCampaignTable = () => {
      ...
      const aggregatedCount=useGetDedupeAggregatedCount(currentPage,pageSize)
    ...
    const recordsLength=aggregatedCount?.data?.records??[]
 ...
 const newRows=aggregatedCount?.data?.records?.map((record)=>(

   <Table.Tr className="hover:bg-gray-50 transition-colors duration-200" key={record.campaign_name}>
                ...
                <Table verticalSpacing="sm" highlightOnHover mt={12}>
                    <Table.Thead>
                      <Table.Tr className="bg-gray-500">
                        ...
                        <Table.Th className="text-gray-500 font-semibold">
                            TOTAL NUMBERS SENT FOR DEDUPE
                        </Table.Th>
                        
                      </Table.Tr>
                    </Table.Thead>
                    <Table.Tbody>
                        {recordsLength?.length>0?(newRows):(
                          <Table.Tr>
                            <Table.Tr>
