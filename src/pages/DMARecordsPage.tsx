                 ...
                 <form>
                    ...
                    <Group justify='flex-end' mt="md" gap="lg">
                      <div className='flex justify-center items-center mt-8 gap-2'>
                        ...
                        <Button variant='subtle' onClick={close} color='red' disabled={fileUploadMutation.isPending} className='hover:bg-gray-100 transition-colors' leftSection={<X size={18}/>}>
                          Cancel
                        </Button>
